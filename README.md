...
[![Build Status](https://drone.io/github.com/freespace8/bee/status.png)](https://drone.io/github.com/freespace8/bee/latest)
...
```bash
go get github.com/freespace8/bee
```
...
```bash
go get -u github.com/freespace8/bee
```
